    ...
    for (let c = 0; c < PROJECTS_PER_ROW; c++) {
      ...
      html += `
        <div class="project">
          ...
          <div class="svg-stroke svg-stroke-3">
            <svg width="2100" height="2200" viewBox="0 0 2100 2200" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="${SVG_PATH_3}" stroke="${project.color}" stroke-width="200" stroke-linecap="round" opacity="0.5"/>
            </svg>
          </div>
